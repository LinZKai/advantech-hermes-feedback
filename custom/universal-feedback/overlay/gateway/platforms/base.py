        ...
        try:
            ...
            if response:
                ...
                if text_content and not _tts_caption_delivered:
                    ...
                    if (
                        hasattr(self, "send_universal_feedback")
                        ...
                        and claim_feedback_ownership(
                            {"universal_feedback_handled": _universal_feedback_handled},
                            event,
                        )
                    ):
                        try:
                            ...
                            pass
                        try:
                            await self.send_universal_feedback(
                                event.source.chat_id,
                                metadata={
                            ...
                            logger.debug("[%s] universal feedback delivery failed", self.name, exc_info=True)
